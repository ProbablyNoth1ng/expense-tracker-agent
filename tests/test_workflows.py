...
class WorkflowTests(unittest.TestCase):
    ...
    def test_completed_reconciliation_uses_rolling_window_without_reading_monthly_sheets(self):
        services = Mock()
        services.settings.initial_sync_date = date(2026, 7, 1)
        services.settings.timezone = "Europe/Warsaw"
        ...
        self.assertEqual(
            services.monobank.iter_statements.call_args.args[1],
            datetime(2026, 7, 18, tzinfo=UTC) - timedelta(days=31),
        )
